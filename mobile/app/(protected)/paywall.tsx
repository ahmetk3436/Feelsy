    ...
    <SafeAreaView className="flex-1 bg-gray-950">
      <ScrollView className="flex-1">
        ...
        <View className="items-center border-b border-gray-800 px-6 pb-6 pt-8">
          <View className="mb-4 h-16 w-16 items-center justify-center rounded-full bg-rose-900/30">
            <Ionicons name="diamond-outline" size={32} color="#f43f5e" />
          </View>
        ...
        {offerings?.availablePackages.map((pkg: PurchasesPackage) => (
          <TouchableOpacity
            key={pkg.identifier}
            className="mx-6 mb-4 flex-row items-center rounded-xl border border-gray-700 bg-gray-900 p-5"
          ...
          >
            ...
            {purchasing === pkg.identifier && (
              <ActivityIndicator color="#f43f5e" style={{ marginLeft: 16 }} />
            )}
          </TouchableOpacity>
        ))}
        ...
        {/* Restore */}
        <TouchableOpacity
          className="mx-6 mt-2 items-center rounded-xl border border-rose-500 p-4"
